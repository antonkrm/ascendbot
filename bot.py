...
"""
        ...
        await message.answer("🔄 Составляю натальную карту и анализирую... Пожалуйста, подождите несколько секунд.")
...
"""
        await message.answer("🔄 Анализирую совместимость... Пожалуйста, подождите немного.")
